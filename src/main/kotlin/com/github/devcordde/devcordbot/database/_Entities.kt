 ...
 * @property blacklisted user is blacklisted for commands
 */
class DatabaseDevCordUser(id: EntityID<Long>) : LongEntity(id), DevCordUser {
    companion object : LongEntityClass<DatabaseDevCordUser>(Users) {
        /**
         * Returns the [DatabaseDevCordUser] corresponding to [id] and created one if needed.
         */
        fun findOrCreateById(id: Long): DatabaseDevCordUser = findById(id) ?: new(id) { }
    }
